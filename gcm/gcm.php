<?php
   ...
   function sendMessageThroughGCM($regIds, $message) {
		...
		define("GOOGLE_API_KEY", "AIzaSyAV1eILD06Xelu3nL4VpOql7H1smh4ECj8"); 		
        $headers = array(
...
<?php
	...
	if(!empty($_GET["push"])) {	
		$gcmRegID  = "APA91bGY3wXjDq5Bi8D4Qh40d2csHQmbOwM1vT5W1wy9nGOGrm6EWu2QMntVDtNXQ2HmAiInQh4pgNJPRsgRiWMefqqjCVUZC9izajdjSP9C6xxXI6cDh3LoUpJknMSwXl8QJqmYQ_8DyK8PaQN2vP2yvki1nsI2PA";
